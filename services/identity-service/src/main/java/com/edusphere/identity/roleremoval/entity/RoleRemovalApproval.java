...
@Entity
@Table(
        name = "role_removal_approvals",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "uk_role_removal_approval_request_approver",
                        columnNames = {"request_id", "approver_user_id"}
                )
        }
)
public class RoleRemovalApproval {
